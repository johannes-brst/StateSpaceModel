...
int main(int argc, char *argv[])
{
	...
	Simulation3.openFromFile(path_to_csv + "AFile.csv", path_to_csv + "BFile.csv", path_to_csv + "CFile.csv",path_to_csv + "DFile.csv", path_to_csv +"x0File.csv",path_to_csv + "inputFile.csv",path_to_csv + "realPlant.csv");
